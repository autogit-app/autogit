...
class IssuesScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final async = ref.watch(myIssuesProvider);

    if (!hasToken) {
      return Scaffold(
        body: CustomScrollView(
          slivers: [
            const LargeAppBar(title: 'Issues'),
            SliverFillRemaining(
              hasScrollBody: false,
              child: Center(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Sign in with GitHub to see your issues',
            ...
            data: (list) {
              ...
              return SliverList(
                delegate: SliverChildBuilderDelegate((context, index) {
                  ...
                  final repoUrl = issue['repository_url'] as String? ?? '';
                  ...
                  return ListTile(
                    ...
                    onTap: () {
                      if (owner != null && repo != null && number != null) {
                        context.push(
                          '/home/issue/${Uri.encodeComponent(owner!)}/${Uri.encodeComponent(repo!)}/$number',
                        );
                      }
                    },
                  );
